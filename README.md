...
私は、学習意欲が高い人間です。エンジニアとしてスキルアップするために、ほぼ毎日、業務時間外にも勉強をしています。勉強はQiitaの記事を読んだり、Meetupに参加したり、オンライン講座を聞いたり、プログラムを書いたりしています。学習した内容はすべてGitHubにコミットしています。
新しい技術をキャッチアップできるエンジニアになるべく


オンライン講座などで勉強しています。オンライン講座はその特性上、言語やフレームワークなどが古い場合も多々ありますが、あえて最新版で使ったり、講座にはない機能を追加することで自分のスキルを底上げを目指しています。学習した内容はすべてGitHubにコミットしています。実務と独学で培ってきた経験を活かし、貴社に貢献したいと考えています。
