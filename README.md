...
エンジニアとして経験年数は長くありませんが、プログラミングに高い学習意欲があり、業務外にもオンライン講座などで毎日勉強しています。オンライン講座はその特性上、言語やフレームワークなどが古い場合も多々ありますが、あえて最新版で使ったり、講座にはない機能を追加することで自分のスキルを底上げを目指しております。
